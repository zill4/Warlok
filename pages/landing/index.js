            ...
            <div className="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
              <div className="absolute inset-0">
                <img
                  ...
                  src="https://images.unsplash.com/photo-1581397867212-e05b3692d16b?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80"
            ...
            <div className="h-full w-full xl:grid xl:grid-cols-2">
              <div className="h-full xl:relative xl:col-start-2">
                <img
                  ...
                  src="https://images.unsplash.com/photo-1490810194309-344b3661ba39?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1890&q=80"
                  alt="People working on laptops"
                />
                <div
                  aria-hidden="true"
          ...
          <div className="xl:grid xl:grid-cols-2 xl:gap-8">
            <div className="grid grid-cols-2 gap-4 xl:col-span-2">
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                    <Link href="/about">
                      <a className="text-sm font-semibold text-gray-500 hover:text-gray-900 tracking-wider uppercase">About</a>
                    </Link>
                </div>
                <div className="mt-12 md:mt-0">
                    <Link href="/contact">
                      <a className="text-sm font-semibold text-gray-500 hover:text-gray-900 tracking-wider uppercase">Contact</a>
                    </Link>
                </div>
              </div>
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                    <Link href="/login">
                      <a className="text-sm font-semibold text-gray-500 hover:text-gray-900 tracking-wider uppercase">Login</a>
                    </Link>
                </div>
                <div className="mt-12 md:mt-0">
                    <Link href="/signup">
                      <a className="text-sm font-semibold text-gray-500 hover:text-gray-900 tracking-wider uppercase">Sign Up</a>
                    </Link>
                </div>
              </div>
            </div>
